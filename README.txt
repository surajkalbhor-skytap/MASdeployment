...
**Git**
To clone and update the repository.
...
For resuming a pending deployment (in case of inter-region deployment), select option 2 and provide the iteration number as instructed by the script.
